...
var codeRow = Titanium.UI.createTableViewRow({height:46, className:'codeRow'}); 
...
var codeLabel = Ti.UI.createLabel({color:'#000000', text:"Registration Code", font:{fontSize:12, fontWeight:'bold'}, top:8, left:12, height:24, width:170});
var codeData = Ti.UI.createLabel({color:'#3D4460', text: reg_code, font:{fontSize:12, fontWeight:'normal'}, top:11, left:102, height:20, width:180, textAlign:'right'});	
...
var picker = new reunion.PickerClass({change: function(){
...
{
	db.updateYearSchool(picker.view.getSelectedRow(0).title, picker.view.getSelectedRow(1).title);
